...
--
-- Majedwali yenyewe yalitengenezwa na V1; hayakuwa na entity za JPA wala
-- audit columns. Migration hii inayaandaa kwa entity zinazorithi
-- BaseEntity, na inaongeza ruhusa mbili za module hii.
--
...
-- permissions kwa existsByCode - hivyo hizi zitarukwa wakati wa seeding na
-- hakuna rudufu. CSV bado inasasishwa kama katalogi ya binadamu.
...
-- RbacSeedService.seedRolePermissions() inaruka role yoyote ambayo TAYARI
-- ina ruhusa - hivyo kwenye database inayotumika, mistari mipya ya
-- role_permissions.csv HAINGETUMIKA KAMWE. Hapa ndipo zinapowekwa.
--
-- Sharti la EXISTS linatofautisha mazingira:
